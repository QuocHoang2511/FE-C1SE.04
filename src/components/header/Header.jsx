...
const Header = () => {
  ...
  return (
    <header className="shadow">
      <nav className="max-w-[1200px] mx-auto bg-white border-gray-200  lg:px-6">
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              ...
              <li class="relative group">
                <Link
                  to="/"
                  className="flex items-center py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-primaryColor hover:text-white lg:hover:bg-transparent lg:border-0 lg:hover:text-primaryColor lg:p-0"
                >
                  <span className="inline-block mr-2.5">Khám Phá</span>
                  <svg
                ...
                {/* <ul class=" w-[180px] hidden absolute pl-3 bg-white border border-gray-200 py-2 mt-1 rounded-lg shadow-md transition-all duration-300 opacity-0 transform scale-95 group-hover:opacity-100 group-hover:scale-100 lg:block z-50">
                  <li className="">
                    <Link
                      to="/qr-code"
